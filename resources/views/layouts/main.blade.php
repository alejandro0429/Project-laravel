        ...
        <div class="fixed-plugin">
          <!--div class="dropdown show-dropdown">
            ...
            <ul class="dropdown-menu">
              <li class="header-title"> Usuario</li>
              ...
              <li class="button-container">
                <a class="dropdown-item" href="http://localhost/condominio/public/logout" onclick="event.preventDefault();document.getElementById('logout-form').submit();" target="_blank" class="btn btn-primary btn-block">Salir</a>
              </li>
