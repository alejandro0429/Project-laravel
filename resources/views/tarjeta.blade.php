...
<div class="contenedor">
    ...
    @endif
    <!-- INPUTS  -->
    <form method="POST" enctype="multipart/form-data" action="{{ route('tarjeta.guardar') }}" id="formulario-tarjeta" class="formulario-tarjeta" enctype="multipart/form-data">
        @csrf
        <div class="grupo">
            <label for="inputNumero">Cuenta del deposito</label>
            <select name="banco" id="inputNumero" maxlength="24" autocomplete="off" value="banco de venezuela">
        ...
        <div class="grupo">
            ...
            <input name="referencia"type="text" id="inputNombre" maxlength="20" autocomplete="off" >
            @error('inputNombre')
            <small>
                <strong>{{$message}}</strong>
            </small>
        ...
        <div class="grupo">
            ...
            <input name="pdf" type="file" id="inputBanco" maxlength="20" autocomplete="off">
            @error('inputBanco')
            <small>
                <strong>{{$message}}</strong>
            </small>
